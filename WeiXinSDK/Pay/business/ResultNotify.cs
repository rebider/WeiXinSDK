    ...
    public class ResultNotify : Notify
    {
        ...
        public override void ProcessNotify()
        {
            ...
            if (!notifyData.IsSet("transaction_id"))
            {
                ...
                OrderQueryFail(orderno, notifyData);
            ...
            else
            {
                ...
                OrderSuccess(orderno, notifyData);
        ...
        /// 订单失败执行函数
        /// </summary>
        public virtual void OrderQueryFail(string orderno, WxPayData notifyData)
        {
        }
        ...
        /// 订单成功执行函数
        /// </summary>
        public virtual void OrderSuccess(string orderno, WxPayData notifyData)
        {
        }
    }
}