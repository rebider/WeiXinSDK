...
namespace WeiXinSDK.Message
{
    ...
    public class ReplyMusicMsg : ReplyBaseMsg
    {
        ...
        protected override string GetXMLPart()
        {
            ...
            {
                return "<Music><Title><![CDATA[" + Title + "]]></Title><Description><![CDATA[" + Description + "]]></Description><MusicUrl><![CDATA[" + MusicURL + "]]></MusicUrl><HQMusicUrl><![CDATA[" + HQMusicUrl + "]]></HQMusicUrl></Music>";
            }
        }
    }
}
